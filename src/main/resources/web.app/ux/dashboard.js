...
//		var ux_grid = my.UX.Widget({ "this": "urn:example:ux:dashboard:grid", type: "urn:factcore:ux:Grid", label: "Grid"});
/*
		var ux_dashboard = my.UX.Widget({ "this": "urn:example:ux:dashboard:form", type: "urn:factcore:ux:Widget", label: "Widget",
...
*/
		var ux_dashboard = my.UX.Widget({ "this": "urn:example:ux:dashboard", type: "urn:factcore:ux:Dashboard", label: "Dashboard", collection: models_dashboard, selectable: true,
	 		factualizer: _default_factualizer, gizmo: {
	 			view: "urn:factcore:ux:Widget", follow: "urn:example:model:child"
	 		}
		 });
		var ux_layout = my.UX.Widget({ "this": "urn:example:ux:layout", type: "urn:factcore:ux:Layout", label: "Layout", views: { "center": ux_dashboard }, el: $("#my_dashboard") });
