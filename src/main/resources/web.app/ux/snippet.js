$(document).ready(function() {
	...
	my.on("booted", function() {
			...
			"where": [
				{
					"this"	: "?that",
					"has"	: "a",
					"that"	: "<urn:factcore:ux:Container>",
				},
				{
					"this"	: "?that",
					"has"	: "ux:contains",
		...
		var pages = my.UX.Widget({ "this": "urn:snippets:ux:pages", type: "urn:factcore:ux:List", label: "Table of Contents", collection: models_pages, selectable: true });

		var library = my.UX.Widget({ "this": "urn:snippets:ux:library", type: "urn:factcore:ux:List", label: "Library", collection: models_library, selectable: true });

		var document = my.UX.Widget({ "this": "urn:snippets:ux:document", type: "urn:factcore:ux:snippet:Document", label: "Document", collection: models_pages, selectable: true });

		var layout = my.UX.Widget({ "this": "urn:snippets:ux:layout", type: "urn:factcore:ux:Layout", label: "Layout",
			views: { "west": pages, "center": document, "east": library }, el: $("#my_factcore"),
		});
