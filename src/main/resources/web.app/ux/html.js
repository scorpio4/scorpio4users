$(document).ready(function() {
	...
	my.on("booted", function() {
		...
		var editor = my.UX.Widget({ "this": "urn:example:ux:html", type: "urn:factcore:ux:HTML", label: "Edit Me", selectable: false,
		...
		var layout = my.UX.Widget({ "this": "urn:example:ux:layout", type: "urn:factcore:ux:Layout", label: "Layout", views: { "west": selector, "center": editor }, el: $("#my_factcore") });
