$(document).ready(function() {
	...
	my.on("booted", function() {
		...
		var selector = my.UX.Widget({ "this": "urn:example:ux:selector", type: "urn:factcore:ux:TagSelect", label: "select tags", collection: models_facet, selectable: true,
	 		factualizer: _default_factualizer
		 });

		var layout = my.UX.Widget({ "this": "urn:example:ux:layout", type: "urn:factcore:ux:Layout", label: "Layout", views: { "north": selector }, el: $("#my_factcore") });
