...
//	 		factualizer: _default_factualizer
		...
		var ux_dropzone = my.UX.Widget({ "this": "urn:example:ux:dropzone", type: "urn:factcore:ux:Dropzone", label: "Drop Zone" });

		var layout = my.UX.Widget({ "this": "urn:example:ux:layout", type: "urn:factcore:ux:Layout", label: "Layout", views: { "center": ux_list, "north": ux_dropzone }, el: $("#my_factcore") });
