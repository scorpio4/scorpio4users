$(document).ready(function() {
	...
	var application = "urn:factcore:application:factbox:";
...
//
	...
	var _default_factualizer = { "this": "urn:factcore:application:factbox:factualizer", trigger: "hover", selector: "[about]", view: Marionette.ItemView.extend({ template: "<span>About: {{label}} - {{comment}}</span>" }) }
...
console.debug("Booted IQ: %o %o", factcore, my.core() );
		...
		var query_grid_columns =  my.fact.asq.register( {
			"this":	"urn:factcore:application:factbox:model:concepts:columns:", lazy: false,
		...
		var query_list_views =  my.fact.asq.register( {
			"this":	"urn:factcore:application:factbox:model:concepts:views:", lazy: false,
			"from":		model_finder, localize: true, finderType: "Remote",
			"where": [
				{
					"this"	: "?this",
		...
		var query_grid =  my.fact.asq.register( {
			"this":	"urn:factcore:application:factbox:model:concepts:", lazy: false,
			...
			"xfollow": {
				"this":	"urn:factcore:application:factbox:model:concepts:child",
				"where": [
					{
						"this"	: "?this",
						"has"	: "a",
...
**/
		...
		var toolbar_menu = new my.fact.factory.FactModels([
			{ "this": "urn:factcore:application:factbox:ux:toolbar#create", label: "Create", comment: "Create entry", icon: "plus"},
			{ "this": "urn:factcore:application:factbox:ux:toolbar#delete", label: "Delete", comment: "Delete entry", icon: "minus"},
			{ "this": "urn:factcore:application:factbox:ux:toolbar#edit", label: "Edit", comment: "Edit entry", icon: "edit"}
		]);

        // Instantiate the UI

		var grid = my.UX.Widget({ "this": "urn:factcore:application:factbox:ux:grid", type: "urn:factcore:ux:Grid", label: "My Fact Sheet", collection: models_grid,
		    selectable: false, paging: false,
			factualizer: _default_factualizer,
			meta: models_grid_columns
		});

		var toolbar = my.UX.Widget({ "this": "urn:factcore:application:factbox:ux:toolbar", type: "urn:factcore:ux:Toolbar", label: "Toolbar", collection: toolbar_menu });

		var filter = my.UX.Widget({ "this": "urn:factcore:application:factbox:ux:filter", type: "urn:factcore:ux:FacetFilter", label: "Filter", meta: models_grid_columns })

		var list = my.UX.Widget({ "this": "urn:factcore:application:factbox:ux:list", type: "urn:factcore:ux:Tree", label: "List", collection: models_grid_columns,
		    selectable: true,
		    factualizer: _default_factualizer, follow: "urn:factcore:application:factbox:model:concepts:child"
		});

		var form = my.UX.Panel({ "this": "urn:factcore:application:factbox:ux:form", type: "urn:factcore:ux:Form", label: "My Form",
		    selectable: false,
			factualizer: _default_factualizer, meta: models_grid_columns,
		    dialog: false, modal: false
		});

		var navbar = my.UX.Widget({ "this": "urn:factcore:application:factbox:ux:navbar", type: "urn:factcore:ux:NavBar", label: "Demo", collection: models_grid,
		    selectable: false,
			factualizer: _default_factualizer,
			el: $("#my_navbar")
		}).render();
		...
		var layout = my.UX.Widget({ "this": "urn:factcore:application:factbox:ux:layout", type: "urn:factcore:ux:Layout", label: "Layout", el: $("#my_factcore"),
		    views: { "north": toolbar, "west": list, "center": grid, "east": filter }
		});

		var listViews = my.UX.Panel({ "this": "urn:factcore:application:factbox:ux:views", type: "urn:factcore:ux:List", label: "List of views", collection: models_list_views, dialog: true });
        listViews.show();
