(function($, my) {
	...
	my.factcore.fact.Facet = function(models, options) {

		this.initialize = function(models, options) {
			if (!options) throw "urn:factcore:fact:missing-options";
			if (!options.domain) throw "urn:factcore:fact:missing-domain";
