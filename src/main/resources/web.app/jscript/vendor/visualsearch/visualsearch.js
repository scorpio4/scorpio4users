...
// FIX: added value to valueMatches() parameters - LC 2/09/2013
    this.options.app.options.callbacks.valueMatches(category, searchTerm, value, function(matches, options) {
      options = options || {};
      matches = matches || [];
