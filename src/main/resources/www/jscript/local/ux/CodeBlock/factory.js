 ...
 * @type {Blockly.Block}
 */
// new EditorBlockly.Block(EditorBlockly.mainWorkspace, 'factory_base');
var rootBlock = null;
...
function initEditor(blockly) {
  ...
  rootBlock = new EditorBlockly.Block(EditorBlockly.mainWorkspace, 'factory_base');
console.log("Blockly:", EditorBlockly, EditorBlockly.mainWorkspace );
  rootBlock.initSvg();
  rootBlock.render();
  rootBlock.editable = true;
  rootBlock.deletable = true;
