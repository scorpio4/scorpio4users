(function($, my) {
	...
	my.scorpio4.UX.View["urn:scorpio4:ux:GraphCompass"] = function(options) {
		var DEBUG = true && my.scorpio4.DEBUG;
		var CENTER = "center";
		...
		var _addModels = function(toolkit, models) {
			...
			models.each(function(model) {
				var _uid = my.scorpio4.UX.uid(model.get(options.typeOf));
		...
		var Widget = Backbone.Marionette.ItemView.extend( _.extend({
			template: false,
			className: my.scorpio4.UX.stylize("ux_graph_compass concept-viewer"),
			initialize: function() {
