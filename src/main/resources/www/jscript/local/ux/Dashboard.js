(function($, my) {
	...
	my.scorpio4.UX.View["urn:scorpio4:ux:Dashboard"] = function(options) {
		...
		var Gizmo = Backbone.Marionette.CompositeView.extend({
			initialize: function(_options) {
				...
				var View = my.scorpio4.UX.View[options.widget];
			...
			tagName: "li", className: my.scorpio4.UX.stylize("ux_gizmo", options),
		...
		var Dashboard = Backbone.Marionette.CompositeView.extend( _.extend({
			itemView: Gizmo, className: my.scorpio4.UX.stylize("ux_dashboards", options),
			...
			onItemviewShow: function () {
				var $nodes = my.scorpio4.UX.factualize(this, options.factualizer );
