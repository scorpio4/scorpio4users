(function($, my) {
	...
	my.scorpio4.UX.Modal = my.scorpio4.UX.View["urn:scorpio4:ux:Modal"] = function(options) {
		var DEBUG = true && my.scorpio4.UX.DEBUG; // master DEBUG kill-switch

		// ensure valid options
		options = my.scorpio4.UX.checkOptions(options, ["this", "label", "type", "widget" ]);
		...
		// create body widget
		var Widget = widget_options.view || my.scorpio4.UX.View[options.type];
		if (!Widget) throw "urn:scorpio4:ux:oops:unknown-widget#"+options.type;

		// attach to DOM
		var $el = $("<div/>").addClass(my.scorpio4.UX.stylize("ux_modal modal hide fade", options));
		$("body").append( $el );
