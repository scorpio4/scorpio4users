(function($, my) {
	...
	my.scorpio4.UX.View["urn:scorpio4:ux:HTML"] = function(options) {
...
DEBUG && console.debug("HTML TextArea:", this, self.options, $textarea);
                if (!$textarea.length) throw "urn:scorpio4:ux:oops:missing-textarea";
...
DEBUG && console.debug("HTML onToolbarInsertProperty", value, view, $this, event);
		...
		}, my.scorpio4.UX.mixin.Common, my.scorpio4.UX.mixin.Attachable, my.scorpio4.UX.mixin.Droppable), {
	...
	my.scorpio4.UX.View["urn:scorpio4:ux:HTMLPages"] = function(options) {
		options = my.scorpio4.UX.checkOptions(options);
...
//		var HTML = my.scorpio4.UX.View["urn:scorpio4:ux:HTML"](options);
		if (!HTML) throw "urn:scorpio4:ux:oops:missing-widget";

		var Pages = Backbone.Marionette.CompositeView.extend( _.extend({
			itemView: HTML, tagName: "ul", className: my.scorpio4.UX.stylize("ux_pages nav-list", options),
