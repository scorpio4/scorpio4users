$(document).ready(function() {
	...
	my.on("booted", function() {
		...
		var viewTree = my.UX.Widget({ "this": "urn:example:ux:button:menu", type: "urn:scorpio4:ux:ButtonBar", label: "Menu", selectable: true, follow: "urn:example:model:navs:has", collection: models_nav_views });
//		var workspace = my.UX.WorkSpace({ "this": "urn:example:ux:workspace", label: "Layout", autoRender: true, views: { "center": viewTree } });

$("#my_scorpio4").append( viewTree.render().el );
