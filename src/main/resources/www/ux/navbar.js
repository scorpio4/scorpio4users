$(document).ready(function() {
	...
	my.on("booted", function() {
		...
		var viewTree = my.UX.Widget({ "this": "urn:example:ux:navbar:view:tree", type: "urn:scorpio4:ux:Tree", label: "View", selectable: true, collection: models_nav_views });

		var navbar = my.UX.Widget({ "this": "urn:example:ux:navbar", type: "urn:scorpio4:ux:NavBar", label: "NavBar", selectable: true,
			menus: [
				{
		...
		var layout = my.UX.Widget({ "this": "urn:example:ux:layout", type: "urn:scorpio4:ux:WorkSpace", label: "Layout", autoRender: true, views: { "center": navbar }, el: $("#my_navbar") });
	})
	my.start();
});
