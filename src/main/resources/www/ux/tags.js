$(document).ready(function() {
	...
	my.on("booted", function() {
		...
		var selector = my.UX.Widget({ "this": "urn:example:ux:selector", type: "urn:scorpio4:ux:TagSelect", label: "select tags", collection: models_facet, selectable: true,
	 		factualizer: _default_factualizer
		 });

		var layout = my.UX.Widget({ "this": "urn:example:ux:layout", type: "urn:scorpio4:ux:Layout", label: "Layout", views: { "north": selector }, el: $("#my_scorpio4") });
