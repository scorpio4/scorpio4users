$(document).ready(function() {
	...
	my.on("booted", function() {
			...
			"where": [
				{
					"this"	: "?this",
					"has"	: "rdfs:subClassOf",
					"that"	: "<urn:scorpio4:ux:Widget>", // <http://www.w3.org/2000/01/rdf-schema#Class>" //
				},
				{
					"this"	: "?this",
					"has"	: "rdfs:label",
		...
		var design = my.UX.Widget({ "this": "urn:example:ux:design", type: "urn:scorpio4:ux:Design", label: "Designer", collection: models_designed, selectable: true,
	 		factualizer: _default_factualizer,
	 		droppable: { selector: ".ux_design", accept: ".ui-draggable" }
		 });

		var selector = my.UX.Widget({ "this": "urn:example:ux:selector", type: "urn:scorpio4:ux:List", label: "MenuButton", collection: models_design, selectable: true,
		...
		var grid = my.UX.Widget({ "this": "urn:example:ux:widgets", type: "urn:scorpio4:ux:Grid", label: "UX Widgets", collection: models_design, selectable: true, paging: false,
			columns: [
		...
		var layout = my.UX.Widget({ "this": "urn:example:ux:layout", type: "urn:scorpio4:ux:Layout", label: "Layout",
			views: { "west": selector, "center": design, "east": grid }, el: $("#my_scorpio4"),
		});
...
console.log("Design Select: ", selector, selector2, that)
		...
		models_designed.add({ "this": "urn:example:designed:buttons:1", "widget": "urn:scorpio4:ux:List", "label":"Buttons #1" });
