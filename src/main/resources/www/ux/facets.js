$(document).ready(function() {
	...
	my.on("booted", function() {
		...
		var facet = my.UX.Widget({ "this": "urn:example:ux:facet", type: "urn:scorpio4:ux:Dashboard3D", label: "Facets", follow: "urn:example:model:child", collection: models_facet, selectable: true,
	 		factualizer: _default_factualizer,
	 		viewable: {
	 			"urn:scorpio4:fact:Finder": ViewFinder
	 		}
		 });

		var selector = my.UX.Widget({ "this": "urn:example:ux:selector", type: "urn:scorpio4:ux:MenuButton", label: "MenuButton", collection: models_facet, selectable: true,
	 		factualizer: _default_factualizer
		 });

		var selector2 = my.UX.Widget({ "this": "urn:example:ux:selector2", type: "urn:scorpio4:ux:List", label: "List", collection: models_facet, selectable: true,
	 		factualizer: _default_factualizer
		 });

		var layout = my.UX.Widget({ "this": "urn:example:ux:layout", type: "urn:scorpio4:ux:Layout", label: "Layout", views: { "west": selector, "center": facet, "east": selector2 }, el: $("#my_facet") });
