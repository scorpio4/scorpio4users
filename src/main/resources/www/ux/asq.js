$(document).ready(function() {
	...
	my.on("booted", function() {
		...
		var query_list =  my.fact.asq.register( {
			...
			"where": [
				{
					"this"	: "<urn:scorpio4:ux:exampleView1>",
					"has"	: "a",
					"that"	: "?this"
				},
				{
...
//		models_ranges.fetch( { "that": "urn:scorpio4:ux:View"} );
//		console.debug("ASQ Range Model:", models_ranges );
		...
		model_asq.set("urn:scorpio4:asq:query", my.fact.asq[query_ranges] );
		...
		var ux_asq = my.UX.Widget({ "this": "urn:example:ux:asq", type: "urn:scorpio4:ux:ASQ", label: "ASQ", model: model_asq, collection: models_ranges });

		var layout = my.UX.Widget({ "this": "urn:example:ux:layout", type: "urn:scorpio4:ux:Layout", label: "Layout", views: { "west": ux_list, "east": ux_asq }, el: $("#my_scorpio4") });
