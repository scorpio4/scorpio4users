$(document).ready(function() {
	...
	my.on("booted", function() {
		var concept_finder = "urn:scorpio4:fact:finder:example:banking";
		...
		var view_concept = my.UX.Widget( { "this": "urn:example:concept:ux:concept:graph", type: "urn:scorpio4:ux:GraphCompass", label: "Concept Viewer", collection: model_relations,
		...
		var workspace = my.UX.WorkSpace({ "this": "urn:example:app:hello", type: "urn:scorpio4:ux:WorkSpace", label: "My Concepts",
			views: {
				"center": view_concept,
			}
		});
