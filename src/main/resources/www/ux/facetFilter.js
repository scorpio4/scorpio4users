$(document).ready(function() {
	...
	my.on("booted", function() {
		...
		var grid = my.UX.Widget({ "this": "urn:example:ux:grid", type: "urn:scorpio4:ux:Grid", label: "Grid", follow: "urn:example:model:child", collection: models_facet, selectable: true,
	 		factualizer: _default_factualizer
		 });

		var facetFilter = my.UX.Widget({ "this": "urn:example:ux:facetFilter", type: "urn:scorpio4:ux:FacetFilter", label: "Facets", collection: models_facet, selectable: true,
	 		factualizer: _default_factualizer
		 });
		...
		var layout = my.UX.Widget({ "this": "urn:example:ux:layout", type: "urn:scorpio4:ux:Layout", label: "Layout", views: { "north": facetFilter, "center": grid, "east": selector }, el: $("#my_scorpio4") });
