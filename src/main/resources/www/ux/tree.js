$(document).ready(function() {
	...
	my.on("booted", function() {
			...
			"where": [
				{
					...
					"has"	: "a",
					"that"	: "<urn:scorpio4:fact:Field>", // <http://www.w3.org/2000/01/rdf-schema#Class>" //
				},
				{
					"this"	: "<urn:example:model:concepts:this>",
					"has"	: "rdfs:label",
		...
		var tree = my.UX.Widget({ "this": "urn:example:ux:tree", type: "urn:scorpio4:ux:Tree", label: "Tree", follow: "urn:example:model:child", collection: models_tree, selectable: true,
	 		factualizer: _default_factualizer
		 });
		var layout = my.UX.Widget({ "this": "urn:example:ux:layout", type: "urn:scorpio4:ux:Layout", label: "Layout", views: { "center": tree }, el: $("#my_tree") });
