$(document).ready(function() {
	...
	my.on("booted", function() {
		...
		var grid = my.UX.Widget({ "this": "urn:snippets:ux:widgets", type: "urn:scorpio4:ux:Grid", label: "UX Widgets", collection: models_snippet, selectable: true, paging: false,
			columns: [
		...
		var layout = my.UX.Widget({ "this": "urn:snippets:ux:layout", type: "urn:scorpio4:ux:Layout", label: "Layout",
			views: { "center": grid }, el: $("#my_scorpio4"),
		});
