jsPlumbToolkit.ready(function() {
	...
	var application = "urn:example:app:hello", my = scorpio4.boot({"this": application});
	...
	my.on("booted", function(bootstrap) {
		...
		query_nodes = {
			"this": 	"urn:scorpio4:ux:query:model:nodes#",
			from: my["this"],
			"where": [
				{
					"this"	: "?that",
		...
		query_node_edges = {
			"this": 	"urn:scorpio4:ux:query:model:edges#",
			from: my["this"],
			"where": [
				{
					"this"	: "<urn:scorpio4:ux:query:model:edges#this>",
					"has"	: "rdfs:label",
					"that"	: "?label"
				},
				{
